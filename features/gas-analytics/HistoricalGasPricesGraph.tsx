...
//   if (gasHistory !== null ) {
//     const gasHistoryArray = gasHistory;

//     const gasArray = [];
//     for (let i = 0; i < gasHistoryArray.length; i++){
//       gasArray.push([gasHistory[0][i].timestamp, gasHistory[0][i].price])
//     }
